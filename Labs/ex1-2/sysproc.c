...
PRIVATE VOID
ConsoleHelp (IN HANDLE StdHandle) {
	fprintf(StdHandle, 
		"EOS Console Help\n\n"
		"\tver\tShow EOS version.\n"
		"\tmm\tDump the secondary page table mapping information of the system process.\n"
		"\tds\tAccess the specified track on the floppy disk.\n"
		"\trr\tTest Round-Robin Algorithm.\n"
		"\tloop\tLoop function.\n "
		"\tsuspend [id]\tSuspend thread by ThreadID[id].\n "
		"\tresume  [id]\tResume thread by ThreadID[id]\n"
		"\tvm [id]\tPrint virtual memory infomation by ProcessID[id].\n"
		"\tpm\tPrint physical memory infomation.\n "
		"\tpt\tShow process and thread infomation.\n "
		"\tdir\tShow root dir infomation.\n"
		"\tsd\tScan disks.\n"
		);
